  ...
  return (
    <div className="cs_doctor_profile cs_style_1">
      <div className="cs_doctor_img">
        <Image src={imgUrl} alt={name} className="cs_radius_25" height={771} width={727} />
      </div>
            ...
            <div className="cs_doctor_meta_left cs_white_color">
              {availableUrl && (
                <Link href={availableUrl}>
                  <Image src="/images/departments/clock.svg" alt="Icon"height={20} width={20}  />
                  Avaibility
                </Link>
              )}
              {callUrl && (
                <Link href={callUrl}>
                  <Image src="/images/departments/call.svg" alt="Icon" height={20} width={20} />
                  Call
                </Link>
              )}
              ...
              {chatUrl && (
                <Link href={chatUrl}>
                  <Image src="/images/departments/chat.svg" alt="Icon" height={20} width={20} />
                  Chat
                </Link>
              )}
            </div>
