        ...
        <div className="cs_appointment_form_fields">
          <div className="cs_appointment_form_field">
            <div className="cs_appointment_form_icon cs_center rounded-circle cs_accent_bg">
              <Image src="/images/home_3/appointment_icon_1.svg" alt="Icon" height={33} width={33} />
            </div>
          ...
          <div className="cs_appointment_form_field">
            <div className="cs_appointment_form_icon cs_center rounded-circle cs_accent_bg">
              <Image src="/images/home_3/appointment_icon_2.svg" alt="Icon" height={33} width={33} />
            </div>
            <div className="cs_appointment_form_field_right">
          ...
          <div className="cs_appointment_form_field">
            <div className="cs_appointment_form_icon cs_center rounded-circle cs_accent_bg">
              <Image src="/images/home_3/appointment_icon_3.svg" alt="Icon" height={33} width={33} />
            </div>
            <div className="cs_appointment_form_field_right">
          ...
          <div className="cs_appointment_form_field">
            <div className="cs_appointment_form_icon cs_center rounded-circle cs_accent_bg">
              <Image src="/images/home_3/appointment_icon_4.svg" alt="Icon" height={33} width={33} />
            </div>
            <div className="cs_appointment_form_field_right">
          ...
          <div className="cs_appointment_form_field">
            <div className="cs_appointment_form_icon cs_center rounded-circle cs_accent_bg">
              <Image src="/images/home_3/appointment_icon_5.svg" alt="Icon" height={33} width={33} />
            </div>
            <div className="cs_appointment_form_field_right">
          ...
          <div className="cs_appointment_form_field">
            <div className="cs_appointment_form_icon cs_center rounded-circle cs_accent_bg">
              <Image src="/images/home_3/appointment_icon_6.svg" alt="Icon" height={33} width={33} />
            </div>
            <div className="cs_appointment_form_field_right">
